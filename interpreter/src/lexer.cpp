...
>>>>>>> a283074 (chenged print and input from statements to std functions)
=======
    vector<string> keywords = {"var","daca","atunci","altfel","executa","cat","timp","pentru","pana","cand","fiecare","repeta","functie"};
>>>>>>> 963596b (partial implementation of functions)
