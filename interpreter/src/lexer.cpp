...
bool iskeyword(const string& word) {
     ...
     */
    vector<string> keywords = {"var","daca","atunci","altfel","executa","cat","timp","pentru","pana","cand","fiecare","repeta","functie","returneaza","intreg","real","sirc","logic","importa","din","ca"};
